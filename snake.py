...
WINDOW_WIDTH = 167  # number of columns of window box 
WINDOW_HEIGHT = 40 # number of rows of window box 
'''
...
while key != ESC:
    ...
    win.addstr(0, 80, 'YOUR SCORE!! ' + str(score) + ' ')
